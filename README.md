...
* [MedImageParse call patterns](./azureml/medimageparse/medimageparse_segmentation_demo.ipynb) - a collection of snippets showcasing how to send various image types to MedImageParse and retrieve segmentation masks. See how to read and package xrays, opthalmology images, CT scans, pathology patches, and more.
